...
public class Channel19 extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        if (widget.getBoolean("availible", false)) {
            for (int id : appWidgetIds) {
                ...
                PendingIntent openNine = PendingIntent.getActivity(context, 0, new Intent(context, LoginActivity.class), 0);
                PendingIntent muteNine = PendingIntent.getBroadcast(context, 0, new Intent("muteChannelNineTeen"), 0);
    ...
    public void onEnabled(Context context) {
        ...
        sharedPreferences.edit().putBoolean("availible", true).apply();
    }
    ...
    public void onDisabled(Context context) {
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences("widget", Context.MODE_PRIVATE);
        sharedPreferences.edit().putBoolean("availible", false).apply();
    }
}
