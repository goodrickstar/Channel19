...
@GlideModule
public class NineteenGlideModule extends AppGlideModule {
    ...
    public static void forget(String url) {
        NineteenGlideModule.DispatchingProgressListener.forget(url);
    }
    public static void expect(String url, NineteenGlideModule.UIonProgressListener listener) {
        NineteenGlideModule.DispatchingProgressListener.expect(url, listener);
    }
    ...
    private static class DispatchingProgressListener implements NineteenGlideModule.ResponseProgressListener {
